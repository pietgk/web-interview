...
export const parseEdge = (line: string): { from: string; to: string; label: string } | null => {
...
/**
 * `source` is one fenced ```mermaid block. The result maps a node id to the
 * labels of its self-transitions.
 */
