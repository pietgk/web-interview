...
export const SOURCE_EVIDENCE_ENTRIES = Object.freeze([
  ...
  { path: 'frontend/src/todos/todoClient.js', treatment: 'node-runtime', rationale: 'The event-driven client exposes injected transport, clock, and subscription boundaries exercised in Node.' },
