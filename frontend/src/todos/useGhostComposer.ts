...
import { isDematerializableTodo } from './todoModel.ts'
 ...
 * `todoList` is the live Todo List, straight from the read model.
 */
export const useGhostComposer = (todoList: TodoList, commands: TodoListCommands) => {
