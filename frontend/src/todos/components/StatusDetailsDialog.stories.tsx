...
import StatusDetailsDialog from './StatusDetailsDialog.tsx'
 ...
 */
const StatusDetailsStory = ({ details, onClose }: ComponentProps<typeof StatusDetailsDialog>) => {
...
}) as Meta<typeof StatusDetailsDialog>

export default meta

export const WithApiFailure = ({
  args: {
    details: {
...
}) as StoryObj<typeof StatusDetailsDialog>
