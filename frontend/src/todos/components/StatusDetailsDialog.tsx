...
import type { StatusBarDetails } from '@web-interview/todos/types'

export const StatusDetailsDialog = ({ open, details, onClose }: {open: boolean, details: StatusBarDetails | null, onClose: () => void}) => (
