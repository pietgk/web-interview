 ...
 * `motion.reducedMotion: 'system'` in `theme.ts`; Storybook's theme toolbar
...
}) as Meta<typeof AccessibilityPlatformProbe>

export default meta

export const SystemPrefsWired = ({
  ...storyDocs(
    [
...
}) as StoryObj<typeof AccessibilityPlatformProbe>
