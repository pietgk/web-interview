  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: process.env.COVERAGE_GATE !== '1' ? undefined : {
        ...
        '**/frontend/src/todos/todoClient.js': { statements: 100, lines: 100, functions: 96, branches: 100 },
        ...
        '**/frontend/src/todos/useGhostComposer.js': { statements: 100, lines: 100, functions: 100, branches: 84 },
